                    ...
                    <div class="col-md-8 col-sm-8">
                        ...
                        <div class="blog-details-text">
                            ...
                            <div class="blog-date no-padding-top margin-eight no-margin-bottom">
                                <!-- post tags -->
                                <h5 class="widget-title margin-one no-margin-top">标签</h5>
                                <?php $this->tags(',', true, '<a>暂时没有标签</a>'); ?>
							</div>
							<div class="col-md-3 col-sm-4 pull-right text-left no-padding-top no-padding-right margin-eight no-margin-bottom">
								<i class="fa fa-angle-double-left">上一篇: <?php $this->thePrev('%s','没有了'); ?></i>
								<br></br>
								<i class="fa fa-angle-double-right">下一篇: <?php $this->theNext('%s','没有了'); ?></i>
							</div>
                            <!-- end post tags -->
                        </div>
                        <!-- end post details text -->
                        ...
                        <div class="text-center margin-eight no-margin-bottom about-author text-left bg-gray">
                            <div class="blog-comment text-left clearfix no-margin">
                                ...
                                <div class="comment-text overflow-hidden position-relative">
                                    <p class="blog-date no-padding-top">&copy 著作权归作者所有</p>
                                    <p class="about-author-text no-margin">本文由 <?php $this->options->title();?> 创作，采用 <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="external nofollow">知识共享署名4.0</a> 国际许可协议许可，本站文章除注明出处或转载外，均为本站原创或翻译，转载前请注明。</p>
                                </div>
                                <!-- end author text -->
                            </div>
                        </div>
