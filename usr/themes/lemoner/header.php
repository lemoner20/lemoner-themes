            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2 pull-left">
						<a class="logo-light" href="<?php $this->options ->siteUrl(); ?>">
							<img alt="" src="<?php echo empty($this->options->logoUrl)?$this->options->themeUrl.'/images/favicon.png':$this->options->logoUrl; ?>" class="logo" />
						</a>
						<a class="logo-dark" href="<?php $this->options ->siteUrl(); ?>">
							<img alt="" src="<?php echo empty($this->options->logoUrl)?$this->options->themeUrl.'/images/lemon.png':$this->options->logoUrl; ?>" class="logo" />
						</a>
					</div>
                    <!-- end logo -->
                    <!-- search and cart  -->
                    <div class="col-md-2 no-padding-left search-cart-header pull-right">
                        ...
                        <div class="top-cart">
                            ...
                            <a href="#" class="shopping-cart">
                                <!-- <i class="fa fa-user"></i><div class="subtitle">用户中心</div> 这里注释掉了用户中心-->
                            </a>
                            <!-- end nav shopping bag -->
                            <!-- shopping bag content -->
                            <div class="cart-content">
                                <p class="buttons">
                                    <?php if($this->user->hasLogin()): ?><a href="<?php $this->options->adminUrl(); ?>" class="btn btn-very-small-white margin-seven btn-block"><?php _e('用户'); ?> (<?php $this->user->screenName(); ?>)</a><a href="<?php $this->options->logoutUrl(); ?>" class="btn btn-very-small-white margin-seven btn-block"><?php _e('退出'); ?></a><?php else: ?><a href="<?php $this->options->adminUrl('login.php'); ?>" class="btn btn-very-small-white margin-seven btn-block"><?php _e('登录'); ?></a><?php endif; ?>
                                </p>
                            </div>
