...
function themeConfig($form) {
	...
	echo '<p style="font-size:14px;" id="use-intro"><span style="display: block;margin-bottom: 10px;    margin-top: 10px;font-size: 16px;">设置主题外观</span></p>';
...
function showThumb($obj,$link=false){
    ...
    $thumb = empty($thumb) ? 'https://unsplash.it/800/500/?random'.rand(1,10) : $thumb;
	//空的话输出随机图
	//随机图0
