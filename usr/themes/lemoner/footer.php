                ...
                <div class="container">
                    ...
                    <div class="col-md-6 col-sm-12 sm-text-center">
                        ...
                        <ul class="list-inline footer-link text-uppercase">
							...
							<?php else : ?>
							<li><a target="_blank" href="http://www.limy.top/">lemoner20</a></li>
                    ...
                    <div class="col-md-6 col-sm-12 footer-social text-right sm-text-center">
						...
						<?php if ($this->options->socialgithub): ?><a target="_blank" rel="external nofollow" href="<?php $this->options->socialgithub(); ?>"><i class="fa fa-github"></i></a><?php endif; ?>
						...
						<!-- modal popup -->
                            ...
                            <span class="slider-subtitle5 black-text no-margin-bottom">微信扫一扫赞助一下</span>
                            
							<p class="margin-four"><img alt="" src="<?php echo empty($this->options->logoUrl)?$this->options->themeUrl.'/images/pay.png':$this->options->logoUrl; ?>"/></p>
                ...
                <div class="container">
                    <div class="row margin-three">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 copyright text-left letter-spacing-1 xs-text-center xs-margin-bottom-one">
                            &copy; <?php echo date("Y"); ?> Powered by <?php $this->options->title();?>. 
                        </div>
                        <!-- end copyright -->
                        <!-- logo -->
